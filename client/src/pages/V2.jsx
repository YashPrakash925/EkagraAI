  ...
  return (
    <div>
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <h1 className="page-title">EkagraAI – Version 2.0 (V2 Roadmap)</h1>
      ...
      <div className="flat-panel" style={{ borderLeft: '3px solid var(--red-accent)', marginBottom: '1.5rem' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', lineHeight: '1.6', marginBottom: '1rem' }}>
          EkagraAI features modular version-based routing. Version configuration is stored dynamically in backend services to support seamless transitions across V1, V2, V3, and future engineering milestones.
        </p>
